...
| --- | --- | --- | --- | --- |
| CLI behavior | Mixed: retained legacy CLI plus the preferred Rust-backed launcher slice | `in progress` | [`contract-inventory.md#cli-behavior`](./contract-inventory.md#cli-behavior) | `--version`, `--help`, config persistence, and the scoped export workflows are Rust-backed; broader CLI behavior remains legacy-owned |
...
| Supported file formats | Mixed: retained legacy runtime plus the scoped Rust-backed export slice | `in progress` | [`contract-inventory.md#supported-file-formats`](./contract-inventory.md#supported-file-formats) | The preferred launcher now owns the scoped export families for G-code, STL, OBJ, AMF, 3MF, and SVG outputs; broader format parity remains legacy-only |
| Generated outputs | Mixed: retained legacy output pipeline plus the scoped Rust-backed export slice | `in progress` | [`contract-inventory.md#generated-outputs`](./contract-inventory.md#generated-outputs) | The preferred launcher now owns scoped output naming and artifact creation for supported exports, but output-content parity is still deferred |
| Launcher path | Mixed: retained legacy launcher plus the preferred Rust-backed launcher package | `in progress` | [`contract-inventory.md#launcher-path`](./contract-inventory.md#launcher-path) | `packages/launcher` now serves the supported Rust-backed CLI slice, while packaged launcher parity remains later work |
