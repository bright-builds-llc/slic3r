...
| `packages/launcher` | Future owner boundary for the Rust/Bazel/shell entrypoint strategy and packaged startup contracts; still a placeholder today |
...
- Placeholder packages should be read as ownership boundaries, not as evidence that user-visible parity has already moved out of the legacy implementation.
