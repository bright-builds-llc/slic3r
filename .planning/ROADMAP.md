...
No active milestone is planned. v1.14 is archived, audited, and phase history
has moved to `.planning/milestones/v1.14-phases/`.

Start the next milestone with `/gsd-new-milestone` so the next cycle creates
fresh requirements before new phase work begins.

## Last Shipped Milestone

v1.14 shipped the semantic Prusa G-code evidence foundation. The milestone
deepened the verified narrow `fork.prusaslicer.gcode-output` evidence path
from structural facts into semantic toolpath evidence while keeping broad
`generated-outputs` in progress.

The shipped evidence chain is:

1. Phase 53: reviewed semantic scope contract and fail-closed scope verifier.
1. Phase 54: source-pinned semantic fixture sidecar and fixture verifier.
1. Phase 55: pure typed Rust semantic parser and readiness metadata.
1. Phase 56: public semantic parity command, mutation guards, exact status
   wording, and package/scope/fixture/port docs.

## Progress

| Milestone | Phases | Plans | Requirements | Audit | Status |
| --- | --- | --- | --- | --- | --- |
| v1.14 PrusaSlicer G-code Semantic Evidence Foundation | 53-56 | 11/11 | 12/12 | passed | Shipped 2026-06-22 |
| v1.13 PrusaSlicer G-code Structural Evidence Expansion | 49-52 | 12/12 | 12/12 | passed | Shipped 2026-06-19 |
| v1.12 PrusaSlicer G-code Output Evidence Foundation | 45-48 | 12/12 | 10/10 | passed | Shipped 2026-06-15 |

## Next Planning

Fresh milestone requirements are intentionally absent after closeout. Use
`/gsd-new-milestone` to define the next version, update `.planning/PROJECT.md`,
create a new `.planning/REQUIREMENTS.md`, and rebuild this roadmap with active
phases.
