...
- [x] 18-01: Model the macOS packaging launcher contract and bundle/startup boundaries
- [x] 18-02: Implement the packaged launcher/startup surface and document the bundle layout expectations for the scoped macOS slice
