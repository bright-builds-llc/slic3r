...
v1.9 shipped on 2026-05-29. Phases 32 through 36 are complete, the milestone
audit passed, and the roadmap is archived for historical traceability. The
next live roadmap should be created by the next milestone cycle.
...
- [x] **Phase 32: Vendor Source Manifest and License Baseline** - Maintainers
  ...
  license/provenance notes. (completed 2026-05-26)
...
- [x] **Phase 35: Flavor Registry Boundary** - Developers can inspect a pure
  ...
  metadata without copied Rust workspaces. (completed 2026-05-27)
...
- [x] **Phase 36: Parity, Fixture, Launcher, and Deferral Templates** -
  ...
  refresh, and deferral templates without overclaiming fork support. (completed
  2026-05-27)
