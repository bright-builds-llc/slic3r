...
template fields and boundary wording are present. source pins and inventories
are planning inputs only, and future fork behavior still needs future
executable parity evidence before it can be called verified.
